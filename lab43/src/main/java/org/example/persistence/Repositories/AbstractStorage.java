...
public abstract class AbstractStorage<T> {
    ...
    public abstract List<CafeDTO> readFromXml(String filename);
    public abstract void writeToXml(String filename, List<CafeDTO> cakes);
    public abstract void writeDataToJsonFile(String filename,List<CafeDTO> cakes);
    public abstract List<CafeDTO> readDataFromJsonFile(String filename);
